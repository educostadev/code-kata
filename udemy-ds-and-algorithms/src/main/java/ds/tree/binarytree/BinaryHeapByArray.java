...
import ds.tree.binarytree.BinaryTree.BinaryTreeLinkedList;

/**
 * Quando o valor de um node é menor que o valor dos filhos = min-heap
 * Quando valor de node é mairo que os filhos = max-heap
 *
 *  Uso descobrir o max ou min em log(n)
 *  Podemos inserir novos numeros em log(n)
 *
 * Uso pratico:
 * Prims Algorithm
 * Heap Sort
...
public class BinaryHeapByArray {
	...
	void printTreeGraphically() {
		...
		PrintTree.vertical(binaryTree.root);
		System.out.println("################################################################################");
	}//end of method
